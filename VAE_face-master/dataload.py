...
if __name__ == "__main__":
    root_dir = "D:/datasets/sidefaces"
    image_files = os.listdir(root_dir)
    train_dataset = MyDataset(root_dir, image_files[:2000], (64, 64), transforms.Compose([ToTensor()]))
    train_loader = DataLoader(train_dataset, batch_size=50, num_workers=1, shuffle=True)
